...
const ThankYou = () => {
  ...
  // === FACEBOOK PIXEL PURCHASE TRACKING (UPDATED) ===
  useEffect(() => {

    // @ts-ignore
    if (typeof fbq !== 'undefined') {

      // reuse same event id from InitiateCheckout
      const savedEventID =
        sessionStorage.getItem('fb_event_id') ||
        ('evt_' + Date.now());
      ...
      console.log("Purchase Event Fired! 💰", savedEventID);
    }
